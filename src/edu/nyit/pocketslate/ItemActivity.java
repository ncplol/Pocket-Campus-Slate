...
public class ItemActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		table = mItem.category.toLowerCase(Locale.US).replace(" ", "_");
	...
	public boolean addFavorite(MenuItem item) {
		mPocketDbHelper.updateItem(table, ItemEntry.COLUMN_NAMES[SAVED], "saved", mItem.pubDate);
		if(mFromSearch) {
			mPocketDbHelper.updateItem(mTable, ItemEntry.COLUMN_NAMES[SAVED], "saved", mItem.pubDate);
		}
		mPocketDbHelper.addItem(mPocketDbHelper.getItem(table, ItemEntry.COLUMN_NAMES[DATE], mItem.pubDate), "saved_stories");
		mIsSaved = true;
		setMenuItem();
	...
	public boolean removeFavorite(MenuItem item) {
		mPocketDbHelper.updateItem(table, ItemEntry.COLUMN_NAMES[SAVED], null, mItem.pubDate);
