...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemTitles = getResources().getStringArray(R.array.menu_array);
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                fragmentManager.beginTransaction().replace(R.id.content_frame, new AllStoriesFragment()).commit();
                break;
            case 1:
                fragmentManager.beginTransaction().replace(R.id.content_frame, new OrgsFragment()).commit();
                break;
            case 2:
                fragmentManager.beginTransaction().replace(R.id.content_frame, new BiosFragment()).commit();
                break;
            case 3:
